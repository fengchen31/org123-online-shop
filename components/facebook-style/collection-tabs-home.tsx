        ...
        <div className="mx-auto max-w-6xl px-4 pb-6">
          <div className="grid gap-6 lg:grid-cols-12">
            ...
            <div className="lg:col-span-3">
              ...
              {/* Profile Description */}
              <div className="mb-4 rounded border border-gray-300 bg-white p-3 text-xs text-gray-700">
            ...
            <div className="lg:col-span-9">
              ...
              <div className="mt-6 rounded border border-gray-300 bg-white p-6 shadow-sm">
